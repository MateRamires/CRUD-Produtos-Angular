...
export class ProductRead2Component implements AfterViewInit {
  //Esse TS nao esta importando as depedencias atraves do constructor como normalmente fazemos, aqui ele esta pegando as depedencias dentro do HTML atraves dos decorators abaixo.
